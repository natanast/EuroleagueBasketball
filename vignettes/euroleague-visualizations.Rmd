...
```{r second_plot, echo=TRUE, fig.width=7, fig.height=5}
...
ggplot(df_plot, aes(x = Capacity_num, y = Team)) +
    ...
    labs(
        title = "Euroleague Teams — Arena Capacity",
        x = "Capacity",
        y = NULL,
        fill = "Team"
    ) +
    ...
    theme(
        ...
        plot.title = element_markdown(size = 16, face = "bold", hjust = 0.5, margin = margin(t = 2, b = 15)),
